    ...
    public:
        ...
        ulong inAttack = 0x07872cf0; //[Buttons] in_attack=0x07872cf0
     
        ulong level = 0x163a9e0;//Miscellaneous LevelName=0x163a9e0
     
        ulong localPlayer = 0x020c21d0 + 0x8; //0x1388eb8 //.?AVC_GameMovement@@=0x020c21d0
     
        ulong entityList = 0x1d10ef8; //cl_entitylist=0x1d10ef8
     
        ulong viewRender = 0x7870410; //[Miscellaneous] ViewRender=0x7870410
        ...
        ulong highlightServerFadeEndTimes = 0x0380; // m_highlightServerFadeEndTimes=0x0380
